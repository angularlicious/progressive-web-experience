...
const modules = [BrowserAnimationsModule, FormsModule, FoundationModule, HttpClientModule, MaterialDesignModule, NgbModule, ReactiveFormsModule, RouterModule, SecurityModule];
